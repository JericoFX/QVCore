...
export function GetPlayerReady(player) {
    ...
    if (
        typeof alt.Player.prototype.citizenid !== 'string' &&
        typeof alt.Player.prototype.money !== 'object' &&
        typeof alt.Player.prototype.charinfo !== 'object' &&
        typeof alt.Player.prototype.metadata !== 'object' &&
        typeof alt.Player.prototype.job !== 'object' &&
        typeof alt.Player.prototype.gang !== 'object'
    ) {
        alt.log('JELOS');
